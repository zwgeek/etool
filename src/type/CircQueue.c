...
// 	rear = rear >= queue->size ? rear - queue->size : rear;
// 	if (rear == queue->front) {
// 		if (queue->mode == ETOOL_CIRCQUEUE_MODE_CREATE) {
...
// 	 // int n;
// 	// for (n = 0; n < 2; n++) {
// 		((long*)queue->data)[0] = ((long*)value)[0];
// 		// ((int*)queue->data)[1] = ((int*)value)[1];
// 	// }
// 	// memcpy(queue->data, value, sizeof(long));
// 	return 0;
// }
